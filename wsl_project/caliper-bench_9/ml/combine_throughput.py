...
root_input_files = ["throughput_results_all_1.xlsx", "throughput_results_all_2.xlsx", "throughput_results_test.xlsx", "throughput_results_new.xlsx"]
...
is_new_filtered_file = combined_df['source_file'].astype(str).str.contains('throughput_results_all_1.xlsx|throughput_results_all_2.xlsx|throughput_results_test.xlsx', case=False, na=False)
...
save_with_category_sheets(raw_save_df, os.path.join(combined_folder, "throughput_raw.xlsx"))

print(f"Saving filtered data to combined folder...")
save_with_category_sheets(clean_save_df, os.path.join(combined_folder, "throughput_filtered.xlsx"))

# Save to existing destinations to avoid breaking downstream scripts
destinations = [
    os.path.join(throughput_results_dir, "throughput_results_all.xlsx"),
    os.path.join(throughput_results_dir, "throughput_combined.xlsx"),
    os.path.join(results_dir, "throughput_results_all.xlsx"),
    os.path.join(results_dir, "xboost", "throughput_results_all.xlsx"),
    os.path.join(results_dir, "xboost_function_wise", "throughput_results_all.xlsx"),
    os.path.join(results_dir, "xboost_general", "throughput_results_all.xlsx")
]
...
csv_destinations = [
    os.path.join(results_dir, "throughput_results_all.csv")
]
...
excel_0ms_dests = [
    os.path.join(combined_folder, 'throughput_filtered_0ms.xlsx'),
    os.path.join(throughput_results_dir, 'throughput_filtered_0ms.xlsx'),
    os.path.join(results_dir, 'throughput_filtered_0ms.xlsx'),
    os.path.join(results_dir, 'xboost_general', 'throughput_latency_0.xlsx'),
    os.path.join(results_dir, 'xboost_general', 'throughput_filtered.xlsx')
]
...
csv_0ms_dest = os.path.join(results_dir, 'throughput_filtered_0ms.csv')
