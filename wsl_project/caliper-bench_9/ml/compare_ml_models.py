...
def main():
    ...
    features = ['load', 'numCaliperWorkers', 'hotParticipants', 'latency', 'ledgerWrites', 'reads', 'payloadBytes']
    ...
    results_filename = 'random_forest_comparison_results.csv'
    results_df.to_csv(results_filename, index=False)
    
    importance_filename = 'random_forest_feature_importances.csv'
