...
class SubmitProduceWorkload extends WorkloadModuleBase {
    ...
    async submitTransaction() {
        ...
        try {
            ...
            const conflictKey = `submitProduce:${farmerId}:${aggregatorId}`;
            await scheduler.submit(conflictKey, features, () => this.sutAdapter.sendRequests(request));
            this.successTxCount++;
