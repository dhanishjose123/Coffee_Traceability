...
df_true = pd.read_excel('../data/xboost/throughput_results_all.xlsx')

print("Loading trained model from 'xboost_1' folder...")
model = joblib.load('../models/xboost_1/general_matrix_model.joblib')
...
df_eval[['function', 'load', 'n_caliper_workers', 'n_hot_key_participants', 'throughput', 'predicted_throughput']].to_excel('../data/xboost/cross_folder_comparison.xlsx', index=False)
print("\nDetailed comparison saved to '../data/xboost/cross_folder_comparison.xlsx'")
