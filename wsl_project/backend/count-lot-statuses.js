...
const { channelName: defaultChannelName } = require("../caliper-bench_9/experiment-matrix-alternate");
...
function printHelp() {
  console.log(`
Usage:
  CHANNEL_NAME=agrochannel0106 CHAINCODE_NAME=coffee_9 node count-lot-statuses.js [options]
