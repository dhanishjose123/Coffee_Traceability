...
CHAINCODE_NAME="${CHAINCODE_NAME:-coffee_11}"
...
Examples:
  ...
  ./channel-stack.sh agrochannel2604 deploy coffee_9
  ./channel-stack.sh agrochannel2604 server+start+caliper coffee_9 50 10 1
  ./channel-stack.sh agrochannel2604 server+start+caliper coffee_9 50 10 1 10
  ./channel-stack.sh agrochannel2604 server+start+caliper coffee_9 50 10 1 auto 10
  ./channel-stack.sh agrochannel2604 server+start+caliper coffee_9 0
  ./channel-stack.sh agrochannel2604 server
  ./channel-stack.sh agrochannel2604 fresh+deploy+server+start
  ./channel-stack.sh agrochannel2604 fresh+deploy+server+start coffee_9
...
const CoffeeAuctionContract = require('./lib/${CHAINCODE_NAME}');

module.exports.contracts = [CoffeeAuctionContract];
EOF
